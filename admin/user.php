...
<div class="card-body">
 ...
 ?>
  <div class="table-responsive">
    ...
    <?php
        $qry = mysqli_query($conn, "SELECT * FROM user_list");
    ?>
       ...
       ?>
          ...
          <tr>
            ...
            <form action="edit_user.php" method="POST";>
              ...
              <button type="submit" name="edit_user" data-toggle="modal" data-target="#editModal" class="btn btn-success">EDIT</button>
              </form>
              </div>
              <div class="form-group">
