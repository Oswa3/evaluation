...
if(isset($_POST['edit_id'])){
  ...
  $qry = mysqli_query($conn,"SELECT * FROM teacher_list WHERE id = '$id' ");
   ...
   ?>
       ...
       <input type="hidden" name="edit_id" value="<?php echo $row['id']; ?>">
        ...
        <div class="form-group">
           ...
           <input name="edit_password" value="<?php echo $row['password']; ?>" type="password" class="form-control" placeholder="Enter Password" required>
        </div>
    
      <div class="modal-footer">
        <a href="new_faculty.php" class="btn btn-secondary">Cancel</a>
