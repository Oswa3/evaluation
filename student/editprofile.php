...
<div class="card text-center" style="width: 18rem;">
  ...
  $qry = mysqli_query($conn,"SELECT * FROM new_student WHERE school_id='$schoolid'");
        ...
        <div class="form-group">
         ...
         <div class="form-group">
           <label>Course || strand</label>
              <input name="edit_course" value="<?php echo $row['course']; ?>" type="text" class="form-control"  required>
        </div>
        
         <div class="form-group">
           <label>Year || Strand</label>
              <input name="edit_year" value="<?php echo $row['year']; ?>" type="text" class="form-control"required>
        </div>
        
         <div class="form-group">
           <label>Block</label>
              <input name="edit_block" value="<?php echo $row['block']; ?>" class="form-control" type="text" required>
        </div>
